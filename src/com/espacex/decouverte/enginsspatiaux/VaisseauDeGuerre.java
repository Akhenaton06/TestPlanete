...
public class VaisseauDeGuerre extends Vaisseau {
    ...
    public void attaque(Vaisseau vaisseauCible, String arme, int duree) {
        if (armesDesactivees) {
            ...
            System.out.println("Un vaisseau de type " + this.type.name() + " attaque un vaisseau de type " + vaisseauCible.type.name() + " en utilisant l'arme " + arme + " pendant " + duree + " minutes.");
